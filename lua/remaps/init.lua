...
set_keymap('n', "<leader>gp", "<cmd>GitConflictPrevConflict<CR>")
set_keymap('n', "<leader>gn", "<cmd>GitConflictNextConflict<CR>")
set_keymap('n', "<leader>co", "<cmd>GitConflictChooseOurs<CR>")
set_keymap('n', "<leader>ct", "<cmd>GitConflictChooseTheirs<CR>")
set_keymap('n', "<leader>cb", "<cmd>GitConflictChooseBoth<CR>")
set_keymap('n', "<leader>cn", "<cmd>GitConflictChooseNone<CR>")
