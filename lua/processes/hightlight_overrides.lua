-- vim.cmd("hi @tag guifg='#8992a7'")
-- vim.cmd("hi @tag.attribute guifg='#999999'")
-- vim.cmd("hi TelescopeMatching guifg='#bada55'")
-- vim.cmd("hi Winbar gui=None guibg='#242424'")
-- vim.cmd("hi WinbarNC guibg='NvimDarkGrey5'")
