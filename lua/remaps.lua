...
local keymaps = {
    ...
    { 'n', "<TAB>1", ":lua require('harpoon.term').gotoTerminal(1)<CR>"},
    { 'n', "<TAB>2", ":lua require('harpoon.term').gotoTerminal(2)<CR>"},
    { 'n', "<TAB>3", ":lua require('harpoon.term').gotoTerminal(3)<CR>"},
    { 'n', "<TAB>4", ":lua require('harpoon.term').gotoTerminal(4)<CR>"},
    { 'n', "<TAB>5", ":lua require('harpoon.term').gotoTerminal(5)<CR>"},
    { 'n', "<TAB>6", ":lua require('harpoon.term').gotoTerminal(6)<CR>"},
    { 'n', "<TAB>7", ":lua require('harpoon.term').gotoTerminal(7)<CR>"},
    { 'n', "<TAB>8", ":lua require('harpoon.term').gotoTerminal(8)<CR>"},
    { 'n', "<TAB>9", ":lua require('harpoon.term').gotoTerminal(9)<CR>"},
